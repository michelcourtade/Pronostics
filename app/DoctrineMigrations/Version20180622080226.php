...
class Version20180622080226 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE chat_messages (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, contest_id INT NOT NULL, event_id INT NOT NULL, message LONGTEXT NOT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, INDEX IDX_EF20C9A6A76ED395 (user_id), INDEX IDX_EF20C9A61CD0F0DE (contest_id), INDEX IDX_EF20C9A6E48FD905 (game_id), INDEX IDX_EF20C9A671F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
